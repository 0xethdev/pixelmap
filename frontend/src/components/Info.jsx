    ...
    return (
        <div className="container">
            <div className='flex flex-col items-center justify-center mt-10 mb-10 '>
                <div className='flex flex-col mb-20 w-[60%] justify-center items-center text-left font-connection text-xs p-3 border-offblack border-2'>
                    <div className='text-center text-white text-sm p-2 mt-3 w-full'>
                        THERE IS NO SUCH THING AS ART. THERE ARE ONLY ARTISTS.
                    </div>
                    <div className='text-right text-darkgrey p-2 mb-6 w-full'>
                        - Ernst Gombrich
                    </div>

                    <div className='border-b-2 border-offblack text-left text-white text-xs p-2 w-full'>
                        INTRODUCING _MOSAIX: A NEW EPOCH OF COLLABORATIVE ARTISTRY AND BLOCKCHAIN INGENUITY
                    </div>
                    <div className=' text-left text-darkgrey p-2 mb-3'>
