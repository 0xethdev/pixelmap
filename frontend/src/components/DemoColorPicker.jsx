...
const ColorPicker = ({ onSelect, pixelColor }) => {
    ...
    return (
        <div className='flex flex-col bg-black text-white font-connection'>
            ...
            <div className='flex flex-row justify-between p-2'>
                ...
                <HexColorInput color={color} onChange={setColor} prefixed='true' className='w-1/2 text-white text-end bg-black font-connection text-xs'/>
            </div>
